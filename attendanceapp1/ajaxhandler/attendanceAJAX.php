...
require_once $path."/attendanceapp1/database/sessionDetails.php";
require_once $path."/attendanceapp1/database/facultyDetails.php";
require_once $path."/attendanceapp1/database/courseRegistrationDetails.php";
require_once $path."/attendanceapp1/database/attendanceDetails.php";
...
if(isset($_REQUEST['action']))
{
    ...
    if($action=="downloadReport")
    {
        ...
        //$rv=$ado->saveAttendance($dbo,$sessionid,$courseid,$facultyid,$studentid,$ondate,$status);
         ...
         $filename="/attendanceapp1/report.csv";
